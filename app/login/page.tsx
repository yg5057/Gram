  ...
  return (
    <div className="flex flex-1 flex-col bg-white px-7 pt-[60px]">
      <div className="mt-6 flex flex-col items-center gap-[18px]">
        <div className="flex h-[76px] w-[76px] items-center justify-center rounded-3xl bg-main shadow-[0_10px_24px_rgba(255,107,157,0.4)]">
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
            <path
              d="M12 3.5c-4.7 0-8.5 3.4-8.5 7.6 0 2.5 1.4 4.7 3.5 6.1V21l3.2-1.8c.6.1 1.2.2 1.8.2 4.7 0 8.5-3.4 8.5-7.6S16.7 3.5 12 3.5Z"
              fill="#fff"
            />
        ...
        <div className="text-center">
          ...
          <div className="mt-1.5 text-[15px] font-medium text-sub">
            친구들과 함께 기록하는 몸무게
          </div>
        </div>
      </div>
      ...
      >
        ...
        {error && (
          <div className="px-1 text-[13px] font-medium text-main-dark">
            {error}
          </div>
        )}
      ...
      <button
        onClick={switchMode}
        className="rounded-2xl border-[1.5px] border-line-strong bg-white py-3.5 text-[15px] font-semibold"
      >
